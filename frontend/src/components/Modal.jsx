...
export default function Modal() {
  ...
  return (
    <div className="w-1/4 h-1/4 bg-white absolute shadow-2xl rounded-lg flex flex-col justify-between p-5 text-center">
      <h2 className=" font-bold text-[1.8rem]">Delete Student</h2>
